...
int main(int argc, char ** argv) {
    ...
    if (!params.public_path.empty()) {
        ...
        svr->Get("/", [](const httplib::Request &, httplib::Response & res) {
            res.set_content(reinterpret_cast<const char*>(index_yx_html), index_yx_html_len, "text/html; charset=utf-8");
            return false;
        });

        svr->Get("/index-old.html", [](const httplib::Request &, httplib::Response & res) {
